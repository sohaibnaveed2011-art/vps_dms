...
'permissions.update','permissions.destroy','users.index','users.store',
'users.show','users.update','users.destroy','assignments.index','assignments.show','organizations.index','organizations.show','organizations.update',
'organizations.destroy','branches.index','branches.store',
'branches.show','branches.update','branches.destroy',
'warehouses.index','warehouses.store','warehouses.show','warehouses.update','warehouses.destroy','warehouse-sections.index','warehouse-sections.store','warehouse-sections.show',
'warehouse-sections.update','warehouse-sections.destroy','outlets.index',
'outlets.store','outlets.show','outlets.update','outlets.destroy','outlet-sections.index','outlet-sections.store','outlet-sections.show','outlet-sections.update',
'outlet-sections.destroy','section-categories.index','section-categories.store',
'section-categories.show','section-categories.update','section-categories.destroy',
'taxes.index','taxes.store','taxes.show','taxes.update','taxes.destroy','financial_years.index','financial_years.store','financial_years.show',
'financial_years.update','financial_years.destroy','partner_categories.store','partner_categories.show','partner_categories.update','partner_categories.destroy',
...
'brands.index','brands.store','brands.show','brands.update','brands.destroy',
'brands.models.index','brands.models.store','brands.models.show','brands.models.update','brands.models.destroy','units.index','units.store','units.show',
'units.update','units.destroy','variations.index','variations.store','variations.show',
'variations.update','variations.destroy','variations.values.index','variations.values.store','variations.values.show',
'variations.values.update','variations.values.destroy','products.index',
'products.store','products.show','products.update','products.destroy','stock-locations.index','stock-locations.store',
'stock-locations.show','stock-locations.update','stock-locations.destroy',
'inventory-batches.index','inventory-batches.store','inventory-batches.show','inventory-batches.update','inventory-batches.destroy','price_lists.index','price_lists.store',
'price_lists.show','price_lists.update','price_lists.destroy','price_lists.items.index','price_lists.items.store',
'items.show','items.update','items.destroy','accounts.index','accounts.store','accounts.select-list',
'accounts.types','accounts.tree','accounts.chart','accounts.trial-balance','accounts.bulk-update',
'accounts.export','accounts.import','accounts.show','accounts.update','accounts.destroy',
'accounts.toggle-status','accounts.balance','accounts.hierarchy','accounts.summary','accounts.restore',
'accounts.force-delete','storage.local',
...
'DB_PASSWORD','REDIS_CLIENT','REDIS_HOST','REDIS_PASSWORD','REDIS_PORT',
'CACHE_STORE','SESSION_DRIVER','QUEUE_CONNECTION','QUEUE_CONNECTION_RABBIT','RABBITMQ_HOST',
'RABBITMQ_PORT','RABBITMQ_VHOST','RABBITMQ_LOGIN','RABBITMQ_PASSWORD','REVERB_APP_ID',
'REVERB_APP_KEY','REVERB_APP_SECRET','REVERB_HOST','REVERB_PORT','REVERB_SCHEME',
'VITE_REVERB_APP_KEY','VITE_REVERB_HOST','VITE_REVERB_PORT','VITE_REVERB_SCHEME','LOG_CHANNEL',
'LOG_LEVEL','FILESYSTEM_DISK','MAIL_MAILER',);
